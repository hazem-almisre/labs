<template>
  <div>
    ...
    <!-- Icon Cards-->
    <div class="row card ml-3 shadow mr-3">
      <div class="card-header text-black" style="font-size: 20px; font-weight: 700">
        <i class="fas fa-chart-area"></i>
        Customer Insert
        <router-link to="/store-Customer" class="btn btn-success"
            style="border-radius: 20px" id="add_new">
          Add New</router-link
        >
      </div>
      <div class="card-body">
        <div class="card-body">
          <div class="table-responsive">
            ...
            /><br /><br />
            <table
              class="table table-striped table-hover table-warning"
              id=""
              width="100%"
              cellspacing="0"
            >
