<template>
    ...
    <!--------------------------Left_Side_"Expense Insert"------------2nd_task----------->
            <div class="card col-lg-5  shadow" style="padding:0">
                <div class="card-header text-dark">
                    <i class="fas fa-chart-area"></i>
                    <b>Expense Insert</b>
                    <a class="btn btn-sm btn-dark text-white" data-toggle="modal" data-target="#exampleModal" id="add_new"> Add Customer</a>
                </div>
...
<!--------------Right_Side_"Product"----------1st_task----------1----->
            <div class="card col-lg-7 " style="padding:0">
                <div class="card-header text-dark">
                    <i class="fas fa-chart-area"></i>
                    <b>Products</b>
                </div>
                ...
                <div class="card-body">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active bg-dark" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">All Product</a>
                        </li>
