<template>
    <div>
        ...
        <!-----Order------->
        <div class="row ">
            <div class="card col-lg-12 shadow mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-6">
                            <ul class="list-group">
                                <li class="list-group-item bg-dark text-white">Customer Details</li>
            ...
            <div class="card col-lg-12 shadow mb-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-hover table-warning " id="" width="100%" cellspacing="0">
